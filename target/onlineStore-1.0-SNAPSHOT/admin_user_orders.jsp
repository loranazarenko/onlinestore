...
<table id="main-container">
    <tr>
        <td class="content">
                ...
                <div class="row justify-content-center">
                    ...
                    <c:if test="${sessionScope.user != null}">
                        <table class="table table-hover">
                            ...
                            <c:set var="k" value="0"/>
                            <c:forEach var="userOrder" items="${allReceiptsStatuses}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-outline-dark mt-auto"
                                           href="${pageContext.request.contextPath}/controller?command=adminUserOrders&receiptId=${userOrder.key.id}&status=paid">
                                            Pay receipt </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-outline-dark mt-auto"
                                           href="${pageContext.request.contextPath}/controller?command=adminUserOrders&receiptId=${userOrder.key.id}&status=canceled">
                                            Cancel receipt </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-outline-dark mt-auto"
                                           href="${pageContext.request.contextPath}/controller?command=adminUserOrders&receiptId=${userOrder.key.id}&status=deleted">
                                            Remove receipt </a>
                                    </td>
                                </tr>
                            </c:forEach>
            ...
            <a class="btn btn-outline-dark mt-auto" href="admin.jsp"> Return to admin page </a>
